...
# When the gift is received from a close relative or a family member, the amount of tax to be paid is 
# determined by the following table, which is also available on the website:
...
price = int(input("Value of gift: "))

if price < 5000 :
    print("No tax!")
elif price >= 5000 and price < 25000 :
    print(f"Amount of tax: {100 + (price - 5000)*0.08} euros")
elif price >= 25000 and price < 55000 :
    print(f"Amount of tax: {1700 + (price - 25000)*0.1} euros")
elif price >= 55000 and price < 200000 :
    print(f"Amount of tax: {4700 + (price - 55000)*0.12} euros")
elif price >= 200000 and price < 1000000 :
    print(f"Amount of tax: {22100 + (price - 200000)*0.15} euros")
elif price >= 1000000 :
    print(f"Amount of tax: {142100 + (price - 1000000)*0.17} euros")
